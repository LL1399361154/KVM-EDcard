...
typedef struct VirtIOPCIEPCI VirtIOPCIEPCI;
typedef struct VirtIOPCIENETPCI VirtIOPCIENETPCI;
...
struct VirtIOBlkPCI {
 ...
 /* virtio-pcie-pci: This extends VirtioPCIProxy.
 */
#define TYPE_VIRTIO_PCIE_PCI "virtio-pcie-pci"
/*
#define VIRTIO_PCIE_PCI(obj) \
        OBJECT_CHECK(VirtIOPCIEPCI, (obj), TYPE_VIRTIO_PCIE_PCI)
*/
struct VirtIOPCIEPCI {
    VirtIOPCIProxy parent_obj;
    VirtIOPCIE vdev;
};


#define TYPE_VIRTIO_PCIE_NET_PCI "virtio-pcie-net-pci"
#define VIRTIO_PCIE_NET_PCI(obj) \
        OBJECT_CHECK(VirtIOPCIENETPCI, (obj), TYPE_VIRTIO_PCIE_NET_PCI)

struct VirtIOPCIENETPCI {
    VirtIOPCIProxy parent_obj;
    VirtIOPCIE vdev;
};
