...
//pcie
#define PCI_DEVICE_ID_VIRTIO_PCIE        0x1011
#define PCI_DEVICE_ID_VIRTIO_PCIE2       0x1012
#define PCI_DEVICE_ID_VIRTIO_PCIE3       0x1013

#define PCI_DEVICE_ID_VIRTIO_PCIE_NET    0x1021
...
/*create virtio-pcie device*/
int pci_create_virtio_pcie(PCIBus *bus);
